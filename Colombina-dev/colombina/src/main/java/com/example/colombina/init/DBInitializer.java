...
public class DBInitializer implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        Tramite tramite = new Tramite("AR-1", "Nombre 1", "Descripcion 1", "Tipo 1", Tramite.EstadoTramite.EN_REVISION, fechaoctubre2024, Tramite.TipoTramite.NACIONAL, 5.0, entidadColombia, solicitud);
        tramiteRepository.save(tramite);
        //************************************************************************************************************************************************ */
        //Datos para mostrar estadisticas
        EntidadSanitaria entidadBrasil = new EntidadSanitaria(2L, "Entidad Sanitaria Brasil", "Brasil", new ArrayList<>());
        entidadSanitariaRepository.save(entidadBrasil);
        EntidadSanitaria entidadArgentina = new EntidadSanitaria(3L, "Entidad Sanitaria Argentina", "Argentina", new ArrayList<>());
        entidadSanitariaRepository.save(entidadArgentina);
        EntidadSanitaria entidadChile = new EntidadSanitaria(4L, "Entidad Sanitaria Chile", "Chile", new ArrayList<>());
        entidadSanitariaRepository.save(entidadChile);
        EntidadSanitaria entidadPeru = new EntidadSanitaria(5L, "Entidad Sanitaria Perú", "Perú", new ArrayList<>());
        ...
        Usuario solicitante1 = new Usuario(4L, "JuanPerez", passwordEncoder.encode("solicitantepass1"),
                "juanperez@example.com", rolSolicitante, new ArrayList<>(), new ArrayList<>(), new ArrayList<>());
        usuarioRepository.save(solicitante1);
        Usuario solicitante2 = new Usuario(5L, "AnaGomez", passwordEncoder.encode("solicitantepass2"),
                        "anagomez@example.com", rolSolicitante, new ArrayList<>(), new ArrayList<>(), new ArrayList<>());
        ...
        Usuario solicitante3 = new Usuario(6L, "CarlosLopez", passwordEncoder.encode("solicitantepass3"),
                        "carloslopez@example.com", rolSolicitante, new ArrayList<>(), new ArrayList<>(), new ArrayList<>());
        ...
        Usuario solicitante4 = new Usuario(7L, "LauraMartinez", passwordEncoder.encode("solicitantepass4"),
                        "lauramartinez@example.com", rolSolicitante, new ArrayList<>(), new ArrayList<>(), new ArrayList<>());
        ...
        Tramite tramite2 = new Tramite("AR-2", "Producto 2", "Descripción 2", "Tipo 2", Tramite.EstadoTramite.APROBADO, fechaNoviembre2023, Tramite.TipoTramite.INTERNACIONAL, 10.0, entidadChile, solicitud2);
        tramiteRepository.save(tramite2);
        Tramite tramite3 = new Tramite("AR-3", "Producto 3", "Descripción 3", "Tipo 3", Tramite.EstadoTramite.APROBADO, fechaNoviembre2023, Tramite.TipoTramite.NACIONAL, 15.0, entidadArgentina, solicitud3);
        tramiteRepository.save(tramite3);
        Tramite tramite4 = new Tramite("AR-4", "Producto 4", "Descripción 4", "Tipo 4", Tramite.EstadoTramite.APROBADO, fechaNoviembre2023, Tramite.TipoTramite.INTERNACIONAL, 20.0, entidadBrasil, solicitud4);
        tramiteRepository.save(tramite4);
        Tramite tramite5 = new Tramite("AR-5", "Producto 5", "Descripción 5", "Tipo 5", Tramite.EstadoTramite.APROBADO, fechaFebrero2024, Tramite.TipoTramite.NACIONAL, 25.0, entidadPeru, solicitud5);
        tramiteRepository.save(tramite5);
        Tramite tramite6 = new Tramite("AR-6", "Producto 6", "Descripción 6", "Tipo 5", Tramite.EstadoTramite.APROBADO, fechaFebrero2024, Tramite.TipoTramite.INTERNACIONAL, 30.0, entidadChile, solicitud6);
        tramiteRepository.save(tramite6);
        Tramite tramite7 = new Tramite("AR-7", "Producto 7", "Descripción 7", "Tipo 5", Tramite.EstadoTramite.RECHAZADO, fechaFebrero2024, Tramite.TipoTramite.NACIONAL, 35.0, entidadArgentina, solicitud7);
        tramiteRepository.save(tramite7);
        Tramite tramite8 = new Tramite("AR-8", "Producto 8", "Descripción 8", "Tipo 5", Tramite.EstadoTramite.PENDIENTE, fechaFebrero2024, Tramite.TipoTramite.INTERNACIONAL, 40.0, entidadBrasil, solicitud8);
        tramiteRepository.save(tramite8);
        Tramite tramite9 = new Tramite("AR-9", "Producto 9", "Descripción 9", "Tipo 5", Tramite.EstadoTramite.EN_REVISION, fechaFebrero2024, Tramite.TipoTramite.NACIONAL, 45.0, entidadPeru, solicitud9);
        tramiteRepository.save(tramite9);
        Tramite tramite10 = new Tramite("AR-10", "Producto 10", "Descripción 10", "Tipo 5", Tramite.EstadoTramite.RECHAZADO, fechaNoviembre2023, Tramite.TipoTramite.INTERNACIONAL, 50.0, entidadChile, solicitud10);
        tramiteRepository.save(tramite10);
        Tramite tramite11 = new Tramite("AR-11", "Producto 11", "Descripción 11", "Tipo 1", Tramite.EstadoTramite.RECHAZADO, fechaDiciembre2023, Tramite.TipoTramite.NACIONAL, 55.0, entidadArgentina, solicitud11);
        tramiteRepository.save(tramite11);
        Tramite tramite12 = new Tramite("AR-12", "Producto 12", "Descripción 12", "Tipo 1", Tramite.EstadoTramite.PENDIENTE, fechaEnero2024, Tramite.TipoTramite.INTERNACIONAL, 60.0, entidadBrasil, solicitud12);
        tramiteRepository.save(tramite12);
        Tramite tramite13 = new Tramite("AR-13", "Producto 13", "Descripción 13", "Tipo 1", Tramite.EstadoTramite.EN_REVISION, fechaFebrero2024, Tramite.TipoTramite.NACIONAL, 65.0, entidadPeru, solicitud13);
        tramiteRepository.save(tramite13);
        Tramite tramite14 = new Tramite("AR-14", "Producto 14", "Descripción 14", "Tipo 1", Tramite.EstadoTramite.APROBADO, fechaMarzo2024, Tramite.TipoTramite.INTERNACIONAL, 70.0, entidadChile, solicitud14);
        tramiteRepository.save(tramite14);
        Tramite tramite15 = new Tramite("AR-15", "Producto 15", "Descripción 15", "Tipo 1", Tramite.EstadoTramite.RECHAZADO, fechaAbril2024, Tramite.TipoTramite.NACIONAL, 75.0, entidadArgentina, solicitud15);
        tramiteRepository.save(tramite15);
        Tramite tramite16 = new Tramite("AR-16", "Producto 16", "Descripción 16", "Tipo 1", Tramite.EstadoTramite.PENDIENTE, fechaMayo2024, Tramite.TipoTramite.INTERNACIONAL, 80.0, entidadBrasil, solicitud16);
        tramiteRepository.save(tramite16);
        Tramite tramite17 = new Tramite("AR-17", "Producto 17", "Descripción 17", "Tipo 4", Tramite.EstadoTramite.EN_REVISION, fechaOctubre2023, Tramite.TipoTramite.NACIONAL, 85.0, entidadPeru, solicitud17);
        tramiteRepository.save(tramite17);
        Tramite tramite18 = new Tramite("AR-18", "Producto 18", "Descripción 18", "Tipo 4", Tramite.EstadoTramite.EN_REVISION, fechaNoviembre2023, Tramite.TipoTramite.INTERNACIONAL, 90.0, entidadChile, solicitud18);
        tramiteRepository.save(tramite18);
        Tramite tramite19 = new Tramite("AR-19", "Producto 19", "Descripción 19", "Tipo 4", Tramite.EstadoTramite.RECHAZADO, fechaDiciembre2023, Tramite.TipoTramite.NACIONAL, 95.0, entidadArgentina, solicitud19);
        tramiteRepository.save(tramite19);
        Tramite tramite20 = new Tramite("AR-20", "Producto 20", "Descripción 20", "Tipo 4", Tramite.EstadoTramite.PENDIENTE, fechaEnero2024, Tramite.TipoTramite.INTERNACIONAL, 100.0, entidadBrasil, solicitud20);
        tramiteRepository.save(tramite20);
        Tramite tramite21 = new Tramite("AR-21", "Producto 21", "Descripción 21", "Tipo 4", Tramite.EstadoTramite.EN_REVISION, fechaFebrero2024, Tramite.TipoTramite.INTERNACIONAL, 105.0, entidadPeru, solicitud21);
        tramiteRepository.save(tramite21);
        Tramite tramite22 = new Tramite("AR-22", "Producto 22", "Descripción 22", "Tipo 4", Tramite.EstadoTramite.EN_REVISION, fechaMarzo2024, Tramite.TipoTramite.INTERNACIONAL, 110.0, entidadChile, solicitud22);
        tramiteRepository.save(tramite22);
        Tramite tramite23 = new Tramite("AR-23", "Producto 23", "Descripción 23", "Tipo 2", Tramite.EstadoTramite.RECHAZADO, fechaAbril2024, Tramite.TipoTramite.NACIONAL, 115.0, entidadArgentina, solicitud23);
        tramiteRepository.save(tramite23);
        Tramite tramite24 = new Tramite("AR-24", "Producto 24", "Descripción 24", "Tipo 2", Tramite.EstadoTramite.PENDIENTE, fechaMayo2024, Tramite.TipoTramite.INTERNACIONAL, 120.0, entidadBrasil, solicitud24);
        tramiteRepository.save(tramite24);
        Tramite tramite25 = new Tramite("AR-25", "Producto 25", "Descripción 25", "Tipo 2", Tramite.EstadoTramite.EN_REVISION, fechaMarzo2024, Tramite.TipoTramite.INTERNACIONAL, 125.0, entidadPeru, solicitud25);
        tramiteRepository.save(tramite25);
        Tramite tramite26 = new Tramite("AR-26", "Producto 26", "Descripción 26", "Tipo 2", Tramite.EstadoTramite.EN_REVISION, fechaDiciembre2023, Tramite.TipoTramite.INTERNACIONAL, 130.0, entidadChile, solicitud26);
        tramiteRepository.save(tramite26);
        Tramite tramite27 = new Tramite("AR-27", "Producto 27", "Descripción 27", "Tipo 2", Tramite.EstadoTramite.RECHAZADO, fechaDiciembre2023, Tramite.TipoTramite.INTERNACIONAL, 135.0, entidadArgentina, solicitud27);
        tramiteRepository.save(tramite27);
        Tramite tramite28 = new Tramite("AR-28", "Producto 28", "Descripción 28", "Tipo 2", Tramite.EstadoTramite.PENDIENTE, fechaDiciembre2023, Tramite.TipoTramite.INTERNACIONAL, 140.0, entidadBrasil, solicitud28);
        tramiteRepository.save(tramite28);
        Tramite tramite29 = new Tramite("AR-29", "Producto 29", "Descripción 29", "Tipo 2", Tramite.EstadoTramite.EN_REVISION, fechaFebrero2024, Tramite.TipoTramite.INTERNACIONAL, 145.0, entidadBrasil, solicitud29);
        tramiteRepository.save(tramite29);
        Tramite tramite30 = new Tramite("AR-30", "Producto 30", "Descripción 30", "Tipo 3", Tramite.EstadoTramite.APROBADO, fechaMarzo2024, Tramite.TipoTramite.INTERNACIONAL, 150.0, entidadBrasil, solicitud30);
        tramiteRepository.save(tramite30);
        Tramite tramite31 = new Tramite("AR-31", "Producto 31", "Descripción 31", "Tipo 3", Tramite.EstadoTramite.EN_REVISION, fechaDiciembre2023, Tramite.TipoTramite.NACIONAL, 155.0, entidadBrasil, solicitud31);
